				...
				(e._addTouchEventListeners = function () {
					...
					if (this._touchSupported) {
						...
						p(this._element.querySelectorAll(oe)).on(
							...
							this._pointerEvent
								? (p(this._element).on(V.POINTERDOWN, function (
										e
								  ) {
										return n(e);
								  }),
								  p(this._element).on(V.POINTERUP, function (
										e
								  ) {
										return i(e);
								  }),
								  this._element.classList.add(ee))
								: (p(this._element).on(V.TOUCHSTART, function (
										e
								  ) {
										return n(e);
								  }),
								  p(this._element).on(V.TOUCHMOVE, function (
										e
								  ) {
										return (function (e) {
